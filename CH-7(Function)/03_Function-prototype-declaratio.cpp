...
// ! If you are writing the function or implementing the function later on after the calling it then you need to provide the prototype declation at the begnning 
